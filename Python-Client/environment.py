...
class Environment:
    ...
    def __init__(self, sim_time: float,
                 ...
                 airspeed=50.0,
                 airsim_frequency_hz=24.0,
                 sim_frequency_hz=240.0,
                 aircraft=x8,
    ...
    def simulation_loop(self, profile: tuple) -> None:
        ...
        graphic_i = 0  # graphic update counter
        graphic_update = 0
        for i in range(update_num):
            graphic_i_old = graphic_i
            graphic_i = relative_update * i
            graphic_update_old = graphic_update
            graphic_update = graphic_i // 1.0

            print(graphic_i_old, graphic_i, graphic_update_old, graphic_update)
